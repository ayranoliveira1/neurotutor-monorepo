...
vi.mock('next/navigation', () => ({
  ...
  usePathname: () => '/admin/notificacoes',
}))
...
describe('NotificationsPagination', () => {
  ...
  it('deve renderizar total de notifica\u00e7\u00f5es no singular', () => {
    render(
    ...
    expect(
      screen.getByText('1 notifica\u00e7\u00e3o encontrada'),
    ).toBeInTheDocument()
  })

  it('deve renderizar total de notifica\u00e7\u00f5es no plural', () => {
    render(
      <NotificationsPagination
        currentPage={1}
        totalPages={5}
