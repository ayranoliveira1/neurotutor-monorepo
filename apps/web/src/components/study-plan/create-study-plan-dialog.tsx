...
import { createStudyPlanAction } from '@/actions/study-plan/create-study-plan'
...
export function CreateStudyPlanDialog({
  ...
  const { form, handleSubmitWithAction, action } = useHookFormAction(
    ...
    zodResolver(createStudyPlanSchema),
    {
      formProps: {
        defaultValues: {
          name: '',
          ...
          startDate: undefined,
          endDate: undefined,
          goals: [{ subject: '', weeklyQuestionsTarget: 10 }],
        },
      },
      actionProps: {
        onSuccess: () => {
        ...
        onError: ({ error }) => {
          toast.error(error.serverError ?? 'Erro ao criar plano de estudo')
        },
      },
    },
  )
      ...
      <DialogContent className="max-h-[90vh] overflow-y-auto sm:max-w-lg">
        ...
        <form onSubmit={handleSubmitWithAction} className="space-y-4">
          ...
          <div className="space-y-2">
            ...
            <Input
              id="plan-description"
              placeholder="Ex: Foco em exatas e linguagens"
          ...
          <div className="grid gap-3 sm:grid-cols-2">
            ...
            <div className="space-y-2">
              <Label htmlFor="plan-end">Data de término</Label>
              <Input
                id="plan-end"
                type="date"
                {...register('endDate')}
              ...
              >
                ...
                <div className="grid gap-3 sm:grid-cols-3">
                  ...
                  <div className="space-y-1">
                    ...
                    />
                    {errors.goals?.[index]?.weeklyQuestionsTarget && (
                      <p className="text-xs text-destructive">
                        {errors.goals[index].weeklyQuestionsTarget?.message}
                      </p>
                    )}
                  </div>
